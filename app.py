...
def api_chat():
    ...
    **Rule 1: Complaint Resolution**
    If the user's query is a complaint about the issues below, you MUST respond ONLY with the contact information provided.
    - Sanitation (water logging, garbage, drain): Mr. Ramesh Kumar (Sanitation Supervisor) at +91 12345 67890.
    - Electricity (power cut, street light): Ms. Sunita Sharma (Junior Engineer) at +91 23456 78901.
    - Water Supply (no water, pipeline leakage): Mr. Anil Verma (Pump Operator) at +91 34567 89012.
    - Public Works (pothole, road damage): Mr. Sanjay Singh (Road Inspector) at +91 45678 90123.
